  ...
  return (
    <>
      ...
      <Typography variant={"body1"}>
        OTP is {otpStatus["2fa_enabled"] ? "enabled" : "disabled"}.
      </Typography>
      <Typography variant={"body1"}>
        Created:{" "}
        {otpStatus["created"] &&
          formatDistanceToNowPretty(parseJSON(otpStatus["created"]))}
      </Typography>
      <Button color={"primary"} variant={"contained"} onClick={register}>
        Register
      </Button>
      <Button color={"primary"} variant={"contained"} onClick={enable}>
        Enable
      </Button>
      <Button color={"secondary"} variant={"contained"} onClick={disable}>
        Disable
      </Button>
