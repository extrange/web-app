...
export const lists = [
  rest.get(API_URL + "/tasks/tasklists/", (req, res, context) => {
    return res(context.delay(), context.status(200), context.json(fakeLists));
  }),
  ...
  rest.post(API_URL + "/tasks/tasklists/", (req, res, context) => {
    ...
    return res(context.delay(), context.status(200), context.json(newList));
  }),
  ...
  rest.put(API_URL + "/tasks/tasklists/:list/", (req, res, context) => {
    ...
    return res(context.delay(), context.status(200), context.json(obj));
  }),
  ...
  rest.post(
    API_URL + "/tasks/tasklists/:list/tasks/",
  ...
  rest.put(
    API_URL + "/tasks/tasklists/:list/tasks/:item/",
    (req, res, context) => {
  ...
  rest.delete(
    ...
    (req, res, context) => {
      ...
      fakeItems[list].splice(
        fakeItems[list].findIndex((e) => e.id === item),
        1
      );
      return res(context.delay(), context.status(200));
    }
