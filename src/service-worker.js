...
// injectManifest will replace the __WB_MANIFEST string by the
// generated precache manifest.
// https://developer.chrome.com/docs/workbox/reference/workbox-build/#type-InjectManifestOptions
// This string must be present somewhere in your service worker file,
...
registerRoute(
  ...
  /*This will serve the /index.html in the cache, to any navigation request
   * by the browser not fulfilling the above exclusion criteria.
   * It will also not work on api.nicholaslyz.com, because that is a different subdomain (so, I don't have to worry about server resources being cached)*/
...
console.log("service-worker.js executed");
